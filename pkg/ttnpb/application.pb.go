...
func (m *CreateApplicationAPIKeyRequest) GetExpiry() string {
	if m != nil {
		return m.Expiry
	}
	return ""
...
var fileDescriptor_57d90136b1f4f7b1 = []byte{
	...
	,
}
...
func (m *CreateApplicationAPIKeyRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Expiry) > 0 {
		...
		i = encodeVarintApplication(dAtA, i, uint64(len(m.Expiry)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Rights) > 0 {
...
func NewPopulatedCreateApplicationAPIKeyRequest(r randyApplication, easy bool) *CreateApplicationAPIKeyRequest {
	...
	this.Expiry = randStringApplication(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
