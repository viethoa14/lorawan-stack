...
const m = defineMessages({
  ...
  freqPlanLocation: 'Choose one. End devices can use any Frequency Plan within a supported Region.',
  ...
  joinEuiAbsence:
    'Contact the manufacturer or your reseller. If they can not provide a JoinEUI, and your end device is programmable, it is okay to use `0000000000000000`, but ensure that you use the same JoinEUI in your device as you enter in The Things Stack.',
  ...
  appKeyAbsence:
    'Contact the manufacturer or your reseller. If they can not provide an AppKey, and your end device is programmable, it is okay to generate one.',
  ...
  devIdLocation:
    'You make it up, so be creative. End device IDs can not be reused by multiple end devices within the same application.',
  ...
  devAddrLocation:
    'For OTAA, the address is created by the Network Server. If using ABP, you must create one and manually enter it in the end device and The Things Stack.',

  appSKeyDescription:
    'After activation, this encryption key is used to secure messages which carry a payload.',
  appSKeyLocation:
    'For OTAA, the key is generated by the Network Server. If using ABP, you must create one and manually enter it in the end device and The Things Stack.',
  ...
  lwVersionDescription:
    'The LoRa Alliance LoRaWAN specification your end device conforms to, which defines which Media Access Control features it supports.',
  lwVersionLocation:
  ...
  classDescription:
    'The LoRaWAN specification defines three end device types. All LoRaWAN end devices must implement Class A, whereas Class B and Class C are extensions to the specification of Class A devices.',
  classLocation:
    'The class capabilities of your end device should be provided by the manufaturer in a datasheet.',
  classAbsence:
    'All end devices support Class A, so you can always use it. Contact your manufacturer or reseller if you can not find information about what additional classes your end device supports.',
